...
//  LUXSim2evtReader.cc
//
//  A support file containing various methods used to read the LUXSim file
...
//  answer_key key;
//
//  // in_file is the luxsim binary file. Save the current location.
//  size_t start_point = in_file.tellg();
//  
//  key.event_number_luxsim = -1;
