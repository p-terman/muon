////////////////////////////////////////////////////////////////////////////////
/*	LUXSimGeneratorWimp.cc
*
* This is the code file for the Wimp generator.
*
********************************************************************************
* Change log
*	18-Jun-2012 - file creation (Daniel)
*   14-Jul-2012 - Modified to account for earth and galactic
...
//					LUXSimGeneratorWimp()
//------++++++------++++++------++++++------++++++------++++++------++++++------
LUXSimGeneratorWimp::LUXSimGeneratorWimp()
{
	name = "Wimp";
...
G4double LUXSimGeneratorWimp::dR(G4double ER, G4double mWimp, G4double mXenon){
...
/*  G4cout << ((x_e + x_min) < x_esc) << "\t" 
         << ((x_min > (x_esc - x_e)) && ((x_e + x_esc) > x_min)) << "\t" 
         << (x_e > (x_min + x_esc)) << "\t" 
         << ((x_e + x_esc) < x_min) << G4endl;*/
  switch(thisCase){
    case 1:
  ...
  G4double dR  = 0.5 * (c * c) * N_T * (rho_D / m_d) * (M_T * sigma_n / (mu_ND * mu_ND));
           dR *= pow(((Z * fp) + ((A - Z) * fn)) / fn, 2.) * zeta * FormFactor * SecondsPerDay / keVperGeV;
...
//					GenerateEventList()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void LUXSimGeneratorWimp::GenerateEventList( G4ThreeVector position, 
            ...
            G4double time)
{
    ...
    luxManager->RecordTreeInsert(currentIso,time, position,sourceByVolumeID,sourcesID);
}

//------++++++------++++++------++++++------++++++------++++++------++++++------
//					GenerateFromEventList()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void LUXSimGeneratorWimp::GenerateFromEventList( G4GeneralParticleSource 
