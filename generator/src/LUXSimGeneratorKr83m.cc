////////////////////////////////////////////////////////////////////////////////
/*	LUXSimGeneratorKr83m.cc
*
* This is the code file for the Kr83m generator.
*
********************************************************************************
* Change log
*   13 Jan 12 - Initial submission for Kr83m Decays. (Nick)
*   14-Jul-2012 - GenerateEventList methods for binary search tree. (Nick)
*   22-Dec-2012 - Different BRs and particle energies. (Matthew)
*   07-Jul-2013 - Co-opted polarization to store decay time. (Matthew)
*/
////////////////////////////////////////////////////////////////////////////////
...
//------++++++------++++++------++++++------++++++------++++++------++++++------
LUXSimGeneratorKr83m::LUXSimGeneratorKr83m()
{
	name = "Kr83m";
...
//                    GenerateEventList()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void LUXSimGeneratorKr83m::GenerateEventList( G4ThreeVector position,
...
//------++++++------++++++------++++++------++++++------++++++------++++++------
void LUXSimGeneratorKr83m::GenerateFromEventList( G4GeneralParticleSource
       *particleGun, G4Event *event, decayNode *firstNode  )
{
    ...
    G4ThreeVector pol; pol[0] = - log( 1.-G4UniformRand() )*154./log(2.); pol[1]=0;pol[2]=0;
