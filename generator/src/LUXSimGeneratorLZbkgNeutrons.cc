////////////////////////////////////////////////////////////////////////////////
/*   LUXSimGeneratorLZbkgNeutrons.cc
*
...
//------++++++------++++++------++++++------++++++------++++++------++++++------
LUXSimGeneratorLZbkgNeutrons::LUXSimGeneratorLZbkgNeutrons()
{
   name = "LZbkgNeutrons";
...
//               GenerateEvent()
//------++++++------++++++------++++++------++++++------++++++------++++++------
//void LUXSimGeneratorLZbkgNeutrons::GenerateEvent( G4GeneralParticleSource *particleGun,
//      G4Event *event )
//------++++++------++++++------++++++------++++++------++++++------++++++------
//                    GenerateEventList()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void LUXSimGeneratorLZbkgNeutrons::GenerateEventList( G4ThreeVector position,
...
//------++++++------++++++------++++++------++++++------++++++------++++++------
void LUXSimGeneratorLZbkgNeutrons::GenerateFromEventList( G4GeneralParticleSource
...
//               GetNeutronEnergy()
//------++++++------++++++------++++++------++++++------++++++------++++++------
G4double LUXSimGeneratorLZbkgNeutrons::GetNeutronEnergy()
{
/*
...
//               GetZPostion()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void LUXSimGeneratorLZbkgNeutrons::SetPosition()
{
...
//               LoadWeights()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void LUXSimGeneratorLZbkgNeutrons::LoadWeights(G4String fileName) {
  std::ifstream file;
  file.open(fileName);
  if (!file.is_open()) {
...
//               LoadNeutronEnergies()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void LUXSimGeneratorLZbkgNeutrons::LoadNeutronEnergies(G4String fileName) {
  std::ifstream file;
  file.open(fileName);
  if (!file.is_open()) {
    G4cout<<G4endl<<G4endl<<G4endl;
  ...
  double energy = 0.;
  for (int i = 0; i < 100; i++) {
     file >> energy >> weight_energy;
     energyWeights[i] = weight_energy;
     neutronEnergies[i] = energy;
  }
  file.close();
}
