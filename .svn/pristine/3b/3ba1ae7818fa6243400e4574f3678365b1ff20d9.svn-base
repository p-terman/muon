...
//                    LUXSimGeneratorMASN()
//------++++++------++++++------++++++------++++++------++++++------++++++------
LUXSimGeneratorMASN::LUXSimGeneratorMASN()
{
    name = "MASN";
...
//                    GenerateEvent()
//------++++++------++++++------++++++------++++++------++++++------++++++------
//void LUXSimGeneratorMASN::GenerateEvent( G4GeneralParticleSource *particleGun,
//        G4Event *event )
//------++++++------++++++------++++++------++++++------++++++------++++++------
//                    GenerateEventList()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void LUXSimGeneratorMASN::GenerateEventList( G4ThreeVector position,
...
//------++++++------++++++------++++++------++++++------++++++------++++++------
void LUXSimGeneratorMASN::GenerateFromEventList( G4GeneralParticleSource
...
//                  GetMuonAngle()
//------++++++------++++++------++++++------++++++------++++++------++++++------
G4double LUXSimGeneratorMASN::GetMuonAngle()
{
...
//                  GetMuonEnergy()
//------++++++------++++++------++++++------++++++------++++++------++++++------
G4double LUXSimGeneratorMASN::GetMuonEnergy()
{
    G4double prob = G4UniformRand();
    G4int indexLo = 0, indexHi = 1000;
...
//                  GetNeutonAngle()
//------++++++------++++++------++++++------++++++------++++++------++++++------
G4double LUXSimGeneratorMASN::GetNeutronAngle()
{
    G4double prob = G4UniformRand();
    G4int indexLo = 0, indexHi = 1000;
...
//                  GetNeutronEnergy()
//------++++++------++++++------++++++------++++++------++++++------++++++------
G4double LUXSimGeneratorMASN::GetNeutronEnergy()
{
    G4double prob = G4UniformRand();
    G4int indexLo = 0, indexHi = 1000;
...
//------++++++------++++++------++++++------++++++------++++++------++++++------
G4double LUXSimGeneratorMASN::GetNeutronMultiplicity()
{
    G4double prob = G4UniformRand();
    G4int indexLo = 0, indexHi = 1000;
