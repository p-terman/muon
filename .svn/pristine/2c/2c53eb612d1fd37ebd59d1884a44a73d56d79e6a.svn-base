////////////////////////////////////////////////////////////////////////////////
/*	LUXSimExampleComplexDetector.cc
*
...
*				check (Kareem)
*	29-Jan-10 - Added optical boundary processes between the copper and liquid
*				Xe parts (Kareem)
*
*/
////////////////////////////////////////////////////////////////////////////////
...
//------++++++------++++++------++++++------++++++------++++++------++++++------
LUXSimExampleComplexDetector::LUXSimExampleComplexDetector()
{
	...
	//	be set at run time using the LUXSimMessenger commands. This 
	...
	logicalVolume = new G4LogicalVolume( outerCryostat_solid,
			luxMaterials->Titanium(), "simplecryostat_log" );
	...
	G4LogicalVolume *cryostatVacuum_log = new G4LogicalVolume(
			cryostatVacuum_solid, luxMaterials->Vacuum(),
			"cryostatVacuum_log" );
	cryostatVacuum_log->SetVisAttributes( luxMaterials->VacuumVis() );
	cryostatVacuum = new LUXSimDetectorComponent( 0, G4ThreeVector(),
	...
	G4LogicalVolume *innerCryostat_log = new G4LogicalVolume(
			innerCryostat_solid, luxMaterials->Copper(),"innerCryostat_log");
	innerCryostat_log->SetVisAttributes( luxMaterials->CopperVis() );
	innerCryostat = new LUXSimDetectorComponent( 0, G4ThreeVector(),
	...
	banks[0] = new LUXSimExamplePMTBank();
	banks[1] = new LUXSimExamplePMTBank();
