...
/*	LUXSimMaterials.cc
*
* This is the code file to contain all the material definitions in LUXSim.
...
//					LUXSimMaterials()
//------++++++------++++++------++++++------++++++------++++++------++++++------
LUXSimMaterials *LUXSimMaterials::LUXMaterials = 0;
LUXSimMaterials::LUXSimMaterials()
{
...
//					GetMaterials()
//------++++++------++++++------++++++------++++++------++++++------++++++------
LUXSimMaterials *LUXSimMaterials::GetMaterials()
{
	return LUXMaterials;
}
...
//					DefineArrays()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void LUXSimMaterials::DefineArrays()
{
...
//					CreateMaterials()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void LUXSimMaterials::CreateMaterials()
{
	//
	//	Isotopes
	...
	liquidXe = new G4Material( "liquidXe", N_l, 1, kStateLiquid,
	...
	//bnc cable: copper + pvc + pe
	//density is weighted avergae of all three
	bncCable = new G4Material( "bncCable", 1.467*g/cm3, 3 );
	bncCable->AddMaterial( copper, 3.*perCent );
	bncCable->AddMaterial( polyethylene, 31.*perCent );
	bncCable->AddMaterial( pvc, 66.*perCent );
	
	//material for LZ PMT cabling conduit: bnc cable + stainless steel + vacuum
	//density is weighted avergae of all three
	lzPMTCablingConduit = new G4Material( "lzPMTCablingConduit", 2.465*g/cm3, 3 );
	lzPMTCablingConduit->AddMaterial( bncCable, 21.*perCent );
	lzPMTCablingConduit->AddMaterial( ss316, 27.*perCent );
	lzPMTCablingConduit->AddMaterial( vacuum, 52.*perCent );
	
	//material for LZ thermosyphon conduit: stainless steel + vacuum (for now)
	//density is weighted avergae of the two
	lzThermosyphonConduit = new G4Material( "lzThermosyphonConduit", 1.598*g/cm3, 2 );
	lzThermosyphonConduit->AddMaterial( vacuum, 80.*perCent );
	lzThermosyphonConduit->AddMaterial( ss316, 20.*perCent );
...
//					SetOpticalProperties()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void LUXSimMaterials::SetOpticalProperties()
{
	...
	G4double setField = luxManager->GetElectricFieldGas();
	gasXeMat->AddConstProperty( "ELECTRICFIELD", setField  );
	setField = luxManager->GetElectricFieldGasWindow();
	gasXeMat->AddConstProperty( "ELECTRICFIELDWINDOW", setField  );
	setField = luxManager->GetElectricFieldGasTop();
	gasXeMat->AddConstProperty( "ELECTRICFIELDTOP", setField  );
	setField = luxManager->GetElectricFieldGasAnode();
	...
	setField = luxManager->GetElectricFieldLiquid();
	liquidXeMat->AddConstProperty( "ELECTRICFIELD", setField  );
	setField = luxManager->GetElectricFieldLiquidSurface();
	liquidXeMat->AddConstProperty( "ELECTRICFIELDSURFACE", setField  );
	setField = luxManager->GetElectricFieldLiquidGate();
	liquidXeMat->AddConstProperty( "ELECTRICFIELDGATE", setField  );
	setField = luxManager->GetElectricFieldLiquidCathode();
	liquidXeMat->AddConstProperty( "ELECTRICFIELDCATHODE", setField  );
	setField = luxManager->GetElectricFieldLiquidBottom();
...
//					CreateOpticalSurfaces()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void LUXSimMaterials::CreateOpticalSurfaces()
{
    ...
    /* ********* Create secondary liquid Xe - Teflon boundary ********* */
    liquidXeTeflonSurfaceSec = new G4OpticalSurface("liquidXeTeflonSurfaceSec",
                                                 unified, groundfrontpainted, dielectric_dielectric);
    // Create new materials table
    ...
    liquidXeTeflonSurfaceMatSec->AddProperty( "EFFICIENCY",
                                          teflonMat->GetProperty("EFFICIENCY"));
    G4double liquidXeTeflonReflSec[2] = { 0.80, 0.80 }; //true value may lie, this
    //might be problematic
    //between >~0.95 and 1.15 (EXO). Look at Vladimir's Sept. LZ meeting talk.
    liquidXeTeflonSurfaceMatSec->AddProperty( "REFLECTIVITY",
                                          photonEnergies_ConstProp, liquidXeTeflonReflSec, 2 );
    // Set surface material table
    liquidXeTeflonSurfaceSec->SetMaterialPropertiesTable(liquidXeTeflonSurfaceMatSec);
    /* *************************************************** */
...
//					CreateVisualAttributes()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void LUXSimMaterials::CreateVisualAttributes()
{
...
//					InitializeMatrix()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void LUXSimMaterials::InitializeMatrix( G4int numEntries, G4int* theMatrix)
{
...
//					InitializeMatrix()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void LUXSimMaterials::InitializeMatrix( G4int numEntries, G4double* theMatrix)
{
	for( G4int i=0; i<numEntries; i++ )
		theMatrix[i] = 0;
}
...
//                                      UpdateElectricField() 
//------++++++------++++++------++++++------++++++------++++++------++++++------
void LUXSimMaterials::UpdateElectricField()
{ 
  //---------- Gas ---------------------- 
...
//					SetLXeTeflonRefl()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void LUXSimMaterials::SetLXeTeflonRefl( G4double r )
{
...
//					SetLXeSteelRefl()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void LUXSimMaterials::SetLXeSteelRefl( G4double r )
{
    G4MaterialPropertiesTable *tmp = 
...
//					SetLXeAbs()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void LUXSimMaterials::SetLXeAbs( G4double l )
{
...
//					SetLXeRayleigh()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void LUXSimMaterials::SetLXeRayleigh( G4double l )
{
...
//					SetGXeTeflonRefl()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void LUXSimMaterials::SetGXeTeflonRefl( G4double r )
{
    G4MaterialPropertiesTable *tmp = 
...
//					SetGXeSteelRefl()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void LUXSimMaterials::SetGXeSteelRefl( G4double r )
{
    G4MaterialPropertiesTable *tmp = 
...
//					SetGXeAbs()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void LUXSimMaterials::SetGXeAbs( G4double l )
{
...
//					SetGXeRayleigh()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void LUXSimMaterials::SetGXeRayleigh( G4double l )
{
...
//					SetAlUnoxQuartzRefl()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void LUXSimMaterials::SetAlUnoxQuartzRefl( G4double r )
{
	G4MaterialPropertiesTable *tmp = 
...
//					SetOpticalDebugging()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void LUXSimMaterials::SetOpticalDebugging( G4bool debug )
{
