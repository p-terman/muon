...
/*	LUXSimMaterials.hh
*
* This is the header file to contain all the material definitions in LUXSim.
...
#ifndef LUXSimMaterials_HH
#define LUXSimMaterials_HH 1
...
class LUXSimMaterials
{
	public:
		...
		static LUXSimMaterials *GetMaterials();
    ...
    inline G4OpticalSurface *LXeTeflonSurfaceSec()
				{ return liquidXeTeflonSurfaceSec; };
	...
	private:
		static LUXSimMaterials *LUXMaterials;
        ...
        G4OpticalSurface *liquidXeTeflonSurfaceSec;
